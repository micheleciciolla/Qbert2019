...
class Cactus {
    ...
    constructor(position) {
        ...
        this.blockGeometry = new THREE.CylinderBufferGeometry( 0.25, 0.25, 4, 14 );
    ...
    build() {
        ...
        */
        ...
        //braccio orizzontale
        const cactusGeometry = new THREE.CylinderBufferGeometry( 0.25, 0.25, 2.5, 14 );
        ...
        const cactusGeometry01  = new THREE.CylinderBufferGeometry( 0.25, 0.25, 1.5, 14 );
        const cactus01 = new THREE.Mesh(cactusGeometry01, this.cactusMaterial);
        cactus01.position.set(0,0.75,1.1);
        blockMesh.add(cactus01);

        //braccio verticale grande
        const cactusGeometry02  = new THREE.CylinderBufferGeometry( 0.25, 0.25, 2.5, 14 );
        const cactus02 = new THREE.Mesh(cactusGeometry02, this.cactusMaterial);
        cactus02.position.set(0,0.95,-0.9);
        blockMesh.add(cactus02);



        const cactusGeometry03  = new THREE.CylinderBufferGeometry( 0.25, 0.25, 1, 14 );
        const cactus03 = new THREE.Mesh(cactusGeometry03, this.cactusMaterial);
        cactus03.position.set(0,1.5,1.5);
        cactus03.rotation.set(1.5,0,0);
        blockMesh.add(cactus03);


        const cactusGeometry04  = new THREE.CylinderBufferGeometry( 0.25, 0.25, 1.5, 14 );
        const cactus04 = new THREE.Mesh(cactusGeometry04, this.cactusMaterial);
        cactus04.position.set(0,2.1,1.1);
        blockMesh.add(cactus04);


        const cactusGeometry05  = new THREE.CylinderBufferGeometry( 0.25, 0.25, 1, 14 );
        const cactus05 = new THREE.Mesh(cactusGeometry05, this.cactusMaterial);
        cactus05.position.set(0,1.5,-1.25);
        cactus05.rotation.set(4.6,0,0);
        blockMesh.add(cactus05);

        const cactusGeometry06  = new THREE.CylinderBufferGeometry( 0.25, 0.25, 1.5, 14 );
        const cactus06 = new THREE.Mesh(cactusGeometry06, this.cactusMaterial);
        cactus06.position.set(0,2.1,-1.6);
        blockMesh.add(cactus06); 
 
        const cactusGeometry07  = new THREE.CylinderBufferGeometry( 0.25, 0.25, 1.5, 14 );
        const cactus07 = new THREE.Mesh(cactusGeometry07, this.cactusMaterial);
        cactus07.position.set(0,2.1,2);
