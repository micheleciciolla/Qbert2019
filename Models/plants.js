...
class Plant {
    ...
    constructor(position) {
        ...
        this.blockGeometry = new THREE.CylinderBufferGeometry( 0.5, 1, 3.5, 14 );
    ...
    build() {
        ...
        */
        ...
        blockMesh.position.set(0, -2.5, 0);
